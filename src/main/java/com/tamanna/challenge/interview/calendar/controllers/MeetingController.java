...
import static com.tamanna.challenge.interview.calendar.configurations.WebSecurityConfiguration.HAS_INTERVIEWER_CANDIDATE_ROLE;
...
@Validated
@AllArgsConstructor
@PreAuthorize(HAS_INTERVIEWER_CANDIDATE_ROLE)
