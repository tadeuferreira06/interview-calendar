...
INSERT INTO schedule (person_id, schedule_day, schedule_hour, update_date, creation_date) VALUES (1L, '2023-05-16', 18, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());

INSERT INTO schedule (person_id, schedule_day, schedule_hour, update_date, creation_date) VALUES (2L, '2023-05-15', 12, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO schedule (person_id, schedule_day, schedule_hour, update_date, creation_date) VALUES (2L, '2023-05-17', 18, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
...
INSERT INTO schedule (person_id, schedule_day, schedule_hour, update_date, creation_date) VALUES (3L, '2023-05-16', 18, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO schedule (person_id, schedule_day, schedule_hour, update_date, creation_date) VALUES (3L, '2023-05-17', 18, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
